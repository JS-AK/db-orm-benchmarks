...
export const start = async (config: ConfigOptions) => {
	...
	const cases = [
		{ benchFunction: Pg.benchSelectOneByOne, queryCount, count, name: "pg.pool", config: pgPoolConfig },
		{ benchFunction: Drizzle.benchSelectOneByOne, queryCount, count, name: "drizzle-orm", config: drizzleConfig },
		{ benchFunction: DbManager.benchSelectOneByOne, queryCount, count, name: "@js-ak/db-manager", config: dbManagerConfig },
		{ benchFunction: Prisma.benchSelectOneByOne, queryCount, count, name: "@prisma/client", config: prismaConfig },
		{ benchFunction: Sequelize.benchSelectOneByOne, queryCount, count, name: "sequelize", config: sequelizeConfig },
		{ benchFunction: TypeOrm.benchSelectOneByOne, queryCount, count, name: "typeorm", config: typeormConfig },
		{ benchFunction: MikroOrm.benchSelectOneByOne, queryCount, count, name: "mikro-orm", config: mikroOrmConfig },
		{ benchFunction: Objection.benchSelectOneByOne, queryCount, count, name: "objection.js", config: objectionJsConfig },
		{ benchFunction: Kysely.benchSelectOneByOne, queryCount, count, name: "kysely", config: kyselyConfig },
	];
