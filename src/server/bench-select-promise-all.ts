...
export const start = async (config: ConfigOptions) => {
	...
	const cases = [
		{ benchFunction: Pg.benchSelect, queryCount, count, name: "pg.pool", config: pgPoolConfig },
		{ benchFunction: Drizzle.benchSelect, queryCount, count, name: "drizzle-orm", config: drizzleConfig },
		{ benchFunction: DbManager.benchSelect, queryCount, count, name: "@js-ak/db-manager", config: dbManagerConfig },
		{ benchFunction: Prisma.benchSelect, queryCount, count, name: "@prisma/client", config: prismaConfig },
		{ benchFunction: Sequelize.benchSelect, queryCount, count, name: "sequelize", config: sequelizeConfig },
		{ benchFunction: TypeOrm.benchSelect, queryCount, count, name: "typeorm", config: typeormConfig },
		{ benchFunction: MikroOrm.benchSelect, queryCount, count, name: "mikro-orm", config: mikroOrmConfig },
		{ benchFunction: Objection.benchSelect, queryCount, count, name: "objection.js", config: objectionJsConfig },
